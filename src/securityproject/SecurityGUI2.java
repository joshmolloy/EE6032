 ...
 * @author Josh
 */
public class SecurityGUI2 extends javax.swing.JFrame implements Runnable{
    Socket soc;    
    String sendTo;
    String LoginName;
    Thread t=null;
 ...
 static {
    ...
    SecurityGUI2(String LoginName,String chatwith) throws Exception
    {
        super(LoginName);
     ...
     */
    public SecurityGUI2() throws IOException {
        initComponents();
    ...
    {        
        while(true)
        {
            try
            {
                ...
                Output.append( "\n" + sendTo + " Says :" + din.readUTF().toString());
            }
            catch(Exception ex)
            {
                ex.printStackTrace();
...
private void initComponents() {
    ...
    public static void main(String args[]) throws IOException, InterruptedException, Exception {
        ...
        SecurityGUI2 gui = new SecurityGUI2("Client2","Client1");
        gui.setVisible(true);
    }
